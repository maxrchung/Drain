...
void Lyric::render() {
	...
	const auto lineSpacing = fontSize * 3.0f;
	...
	place("song:", Vector2(0, lineSpacing * 0.5f), Time("01:03:319").ms, Time("01:05:584").ms, fontSize);
	place("drain", Vector2(0, -lineSpacing * 0.5f), Time("01:03:602").ms, Time("01:05:584").ms, fontSize);
