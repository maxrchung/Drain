...
// Optionally specify a multipler or divisor
// RandomRange(20, 40, 10).calculate() and RandomOffset::calculate(20, 40, 10) will return numbers between 2 and 4
class RandomRange {
public:
	RandomRange(const int start, const int end, const float divisor = 1.0f);
